...
public class Student {
	...
	private String student_imagePath;
	private int rollno;
...
public Student(String name, String email, String course, int fee, int paid, int due, String address, String city,
		String state, String country, String contactno, String student_imagePath) {
	super();
	this.name = name;
	this.email = email;
	this.course = course;
	...
	this.student_imagePath = student_imagePath;
}

public Student(int rollno, String name, String email, String course, int fee, int paid, int due, String address,
		String city, String state, String country, String contactno, String student_imagePath) {
	super();
	this.rollno = rollno;
	this.name = name;
	this.email = email;
...
public void setContactno(String contactno) {
	...
	public String getStudent_imagePath() {
		return student_imagePath;
	}

	public void setStudent_imagePath(String student_imagePath) {
		this.student_imagePath = student_imagePath;
	}
