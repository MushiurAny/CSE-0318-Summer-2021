...
public class EditStudent extends JFrame {
	...
	public EditStudent() {
		...
		student_Image.setSize(100,100);
		student_Image.addMouseListener(new MouseListener() {
			@Override
			public void mouseClicked(MouseEvent e) {
				...
				if(result == JFileChooser.APPROVE_OPTION){
					...
					student_Image.setIcon(ResizeImage(path));
					setImgpath(path);
				}
				//if the user click on save in Jfilechooser
		...
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//System.out.println(rollno+" "+name+" "+email+" "+course+" "+fee+" "+paid+" "+due+" "+address+" "+city+" "+state+" "+country+" "+contactno+" "+ imagePath);
				Student s=new Student(rollno,name,email,course,fee,paid,due,address,city,state,country,contactno,imagePath);
		...
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				setImgpath(s.getStudent_imagePath());
				...
				student_Image.setIcon(imageIcon);
				}
			}
		});
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(student_Image, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
						.addGap(20))
		);
